...
We also decided to categorize the all of the different types of crime that were reported. We organized the 39 types of crimes into variable crime type, which consists of "Property", "Violent", "White Collar", "Drug/Alcohol", "Sex", "Suspicious", "Legal Violation", and "Miscellaneous".
...
# ggplot(data = important, aes(x = X, y = Y, color = crimetype))+
  # geom_point(data = important, aes(x = X, y = Y, color = crimetype) ,alpha = 0.5, size = .5)
