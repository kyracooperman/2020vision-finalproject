...
Because of the fairly equal distribution of crime by day, we decided to delver further by comparing each crime type by day. 
...
```
By looking at the table and bar plot, it is clear that Ingleside, Bayview, and 
...
- t test results and analsyis done TINA 
